local CustomStochasticGradient = {}

function CustomStochasticGradient:init(module, criterion)
...
function CustomStochasticGradient:train(dataset)
   local iteration = 1
...
return CustomStochasticGradient
